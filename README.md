...
Specifically, earnings call transcript files were used. First, I create an initial embedding of the document using ingest/ingest.py.
...
So, it is set as default for now. Of course, these upstream models are not trained for earnings calls. That would be the gold standard and I would need more resources. 
